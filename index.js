function App() {
    ...
    return (
        ...
        value={dataType}
            >
          <option value="casesPerOneMilion">Cases Per One Million</option>
          <option value="cases">Cases</option>
          <option value="deaths">Deaths</option>
          <option value="tests">Tests</option>
          <option value="deathPerOneMilion">Deatths Per One Million</option>
        </select>
        <label htmlFor="widthofbar">
            width of Bar
            <input name="widthofbar"
            type="number"
            value={widthOfBar}
